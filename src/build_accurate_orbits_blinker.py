...
<body>
    ...
    <header>
        <div class="logo-title">
            <span class="logo-badge">Keplerian Dynamics</span>
    ...
    <div class="workspace">
        ...
        <main class="viewport-container">
            <div class="epoch-overlay">
                ...
                <div id="epochSub" class="epoch-details">18-Year Orbital Motion | i = 28.0°, Ω = 62.0°</div>
            </div>
