"""
Generate high-contrast, visually obvious HR 8799 Blink Comparator.
Defaults to Epoch A = 2008.8 (Keck II) vs Epoch B = 2026.2 (JWST NIRCam).
Features live flashing frame indicators, distinct colormaps, and 18-year orbital motion display.
"""
...
def create_high_contrast_blinker():
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .blink-indicator.active { background: var(--accent-cyan); box-shadow: 0 0 12px var(--accent-cyan); }
...
<body>
    ...
    <header>
        <div class="logo-title">
            <span class="logo-badge">High-Contrast Optical Suite</span>
    ...
    <div class="workspace">
        ...
        <aside class="panel">
            ...
            <div class="control-group">
                ...
                <div class="btn-grid">
                    <button id="btnShowA" class="btn">Show Frame A</button>
                    <button id="btnShowB" class="btn">Show Frame B</button>
                </div>
            </div>
        ...
        <main class="viewport-container">
            <div class="epoch-overlay">
                <div id="epochTitle" class="epoch-tag">FRAME A: 2008.8 (Keck II)</div>
                <div id="epochSub" class="epoch-details">Filter: L' Band (3.77 μm) | Scale: 91.15 px/arcsec</div>
            </div>

            <div class="viewer-box">
                <!-- HIGH-CONTRAST ASTRONOMICAL IMAGES -->
                <img id="img_2008" class="astro-image active" src="images/hr8799_epoch_2008.png" alt="2008.8 Epoch">
                <img id="img_2015" class="astro-image" src="images/hr8799_epoch_2015.png" alt="2015.5 Epoch">
                <img id="img_2022" class="astro-image" src="images/hr8799_epoch_2022.png" alt="2022.9 Epoch">
    ...
    <script>
        ...
        function updateDisplay() {
            ...
            // Toggle active PNG image element with explicit z-index & opacity
...
"""
    ...
    print(f"✅ Created high-contrast 2008 vs 2026 Blink Comparator at: {HTML_PATH}")

if __name__ == "__main__":
    create_high_contrast_blinker()
